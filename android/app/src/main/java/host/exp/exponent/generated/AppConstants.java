...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@fael.f/issueBuild";
  public static final String SHELL_APP_SCHEME = "expbde9132a95544f429badf9fed2b91c27";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@fael.f/issueBuild", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40fael.f%2FissueBuild%2F1.0.0%2F14cc7094bd019511f702de532c84ce8c-34.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
